...
def process_song_file(cur, filepath):
    ...
    cur.execute(dim_song_table_insert, song_data)
    ...
    cur.execute(dim_artist_table_insert, artist_data)
...
def main():
        ...
        """
        conn = psycopg2.connect(host="127.0.0.1", dbname="sparkifydb", user="postgres", password="admin", port=5433)
        cur = conn.cursor()
